...
flags.DEFINE_string("run_id", "4", "Run ID [0]")
...
flags.DEFINE_integer("batch_size", 32, "Batch size [60]")
...
flags.DEFINE_string("attention_cnn_out_dims", "200,200,3,3", "Out channel dims for attention CNN [200]")
